...
<!--    <h3 style="text-align: center"><strong>Question Type: </strong>--><?php //echo $pollingQuizQuestion->pollingQuizQuestionType->name ?><!-- </h3>-->
    <div class="col-md-12">
        <form class="form-horizontal">
            ...
            <!--<div class="form-group form_m">
                <label class="control-label col-sm-3" style="font-size: 23px;" for="email">Correct :</label>
                <div class="col-sm-9">
                    <p type="password" class="form-control" id="pwd" style="border: 0;font-size: 23px;"><?/*= $PollingQuizResultModel->correctAnswer */?></p>
                </div>
            </div>-->
        </form>
    </div>
