 ...
 ** ***************************************/
 ...
 var admintres = function(){
     ...
     $(document).on('click', 'ul.sidebar_list > li', function (e) {
     ...
     // Add 'has-dropdown' class to sidebar links that have a dropdown
     $('.sidebar_link + .notika-main-menu-dropdown').prev('.sidebar_link').addClass('has-dropdown');

     $(document).ready(function() {
         $('.notika-main-menu-dropdown').each(function() {
             // Check if any li within this .notika-main-menu-dropdown has class 'active'
             var item = $(this).find('li');
             if (item.hasClass('active')) {
                 // If true, set display to 'block' for the parent of this .notika-main-menu-dropdown
     ...
     // Listen for clicks on sidebar links
      $('.sidebar_link.has-dropdown').on('click', function(e) {
          e.preventDefault(); // Prevent the default link behavior
          var $parentLi = $(this).parent();

          // Check if the current dropdown is already open
          var isOpen = $parentLi.hasClass('dropdown-open');
