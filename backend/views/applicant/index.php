...
<!--             ->label(false); ?>-->
<!--    </div> -->
            <?php             if(Yii::$app->user->identity->getRole() != GlobalConstant::ROLE_SUPERADMIN){ ?>
    <p>
  ...
  ?>
        ...
        'columns' => [
           ...
           ['attribute'=>'email',
            ...
            ['attribute'=>'textarea_1716885445830',
                         'filterInputOptions' => [
            'class' => 'form-control search border',
            'placeholder' => (new backend\models\Applicant)->getAttributeLabel('textarea_1716885445830'),
                         ],
                     ],
...
return'<a class="btn btn-default edit" href="'.$url.'" title="Cases"><i class="fa fa-suitcase"></i></a>';
            ...
            'template' => Yii::$app->user->identity->getRole() != GlobalConstant::ROLE_SUPERADMIN ? '{dependent}{view} {link} {update} {delete}': '{view}',
            ],
        ],
    ]); ?>
    </div>
