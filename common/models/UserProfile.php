 ...
 * @property string $organisation_size
 * @property integer $business_domain_id
 * @property integer $business_domain_other
 * @property User $user
 */
class UserProfile extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'locale' => Yii::t('common', 'Select Language'),
            'picture' => Yii::t('common', 'Picture'),
            'gender' => Yii::t('common', 'Select Gender'),
        ];
    }
